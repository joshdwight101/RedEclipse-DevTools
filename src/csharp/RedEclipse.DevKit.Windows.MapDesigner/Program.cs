...
var form = new Form { Text = "Red Eclipse - Map Designer", Width = 900, Height = 600 };
...
run.Click += (_, _) =>
{
    var psi = PowerShellRunner.Build(ToolkitPaths.Script("src/powershell/Tools/MapDesigner/Start-MapDesigner.ps1"));
