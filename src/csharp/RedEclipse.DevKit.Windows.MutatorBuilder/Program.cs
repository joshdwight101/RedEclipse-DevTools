...
var form = new Form { Text = "Red Eclipse - Mutator Builder", Width = 900, Height = 600 };
...
run.Click += (_, _) =>
{
    var psi = PowerShellRunner.Build(ToolkitPaths.Script("src/powershell/Tools/MutatorBuilder/Start-MutatorBuilder.ps1"));
