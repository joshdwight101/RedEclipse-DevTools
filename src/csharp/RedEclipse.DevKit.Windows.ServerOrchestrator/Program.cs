...
var form = new Form { Text = "Red Eclipse - Server Orchestrator", Width = 900, Height = 600 };
...
run.Click += (_, _) =>
{
    var psi = PowerShellRunner.Build(ToolkitPaths.Script("src/powershell/Tools/ServerOrchestrator/Start-ServerOrchestrator.ps1"));
