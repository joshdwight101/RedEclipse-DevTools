...
choice=$(zenity --list --title="Red Eclipse DevKit" --width=560 --height=500 --column="Launcher" \
  "Start Entire Suite" "Map Designer" "Mutator Builder" "Asset Pipeline" "Asset Manager" "Model Manager" "Variable Preset Manager" "Server Orchestrator" "Install In-Game Mod Menu" "Start IPC Bridge" "Open Web Dashboard" "Start Docker Server")
